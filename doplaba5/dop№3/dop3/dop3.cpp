...
int main() {
	...
	(a * b - p * q < r * s) ? cout << "На таком участке застройки нельзя расположить два дома с такими размерами." : cout << "На таком участке застройки можно построить такие два дома.";
}